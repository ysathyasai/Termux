...
```css
curl -o ~/.bashrc https://raw.githubusercontent.com/ysathyasai/Termux/main/General/.bashrc
source ~/.bashrc
```
Orelse check this [ .bashrc file](https://github.com/ysathyasai/Termux/tree/main/General/.bashrc/) once.
